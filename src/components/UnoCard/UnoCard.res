...
let make = (~cardContent: Common.cardContent, ~cardColor: Common.cardColor) => {
  let mainContent = switch cardContent {
    ...
    | Nine => React.string("9")
    | PlusTwo => <PlusTwoIcon cardColor=cardColor />
    | PlusFour => <PlusFourIcon />
    | Reverse => <ReverseIcon cardColor=cardColor size=Big />
    | Block => <BlockIcon cardColor=cardColor size=Big />
  ...
  let smallContent = switch cardContent {
    ...
    | Reverse => <ReverseIcon cardColor=cardColor size=Small />
    | Block => <BlockIcon cardColor=cardColor size=Small />
  ...
  <div className="select-none p-4 rounded shadow-lg w-64 h-96 bg-white cursor-pointer transform transition-transform duration-150 hover:-translate-y-14">
    <div className=`${bgColor} h-full rounded flex flex-col justify-between grid w-full uno-card__content-wrapper`>
      ...
      <div className="uno-card__main-content h-5/6 w-full bg-white flex items-center justify-center self-center">
        <p className=`font-bold font-sans text-9xl ${textColor}`>
          mainContent
        </p>
      </div>
      <p className="font-bold font-sans text-3xl text-white p-1 justify-self-end">
        smallContent
      </p>
    </div>
  </div>
